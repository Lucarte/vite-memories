	...
	return (
		<div className='flex flex-col items-center h-[84vh] overflow-hidden text-center'>
			...
			<div className='absolute mt-16 w-52 h-52'>
				<div className='top-0 left-0 text-xl tracking-widest text-center text-black uppercase dark:text-white'>
					<p className='h-6 pt-[.1rem] pl-[.1rem] underline w-fit'>
						MUSIC-THEATER
					</p>
					<p className='absolute right-0 h-6 mt-[3.9rem] -mr-[5.0rem] rotate-90 underline text-black dark:text-white text-opacity-95 dark:text-opacity-95'>
						MUSIC-THEATER
					</p>
			...
			<div className='mt-72'>
				<Link
					to='/memory/create'
					className='relative inline-block h-[1.8rem] px-3 pt-3 text-white bg-black rounded-tl-lg rounded-tr-lg dark:bg-white dark:text-black mb-6'>
